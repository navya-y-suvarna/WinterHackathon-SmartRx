...
const QuickActions = () => {
    ...
    return (
        <div className="bg-white/95 backdrop-blur-sm border-2 border-slate-200 rounded-2xl shadow-sm p-6 transition-all duration-300 hover:shadow-[0_8px_48px_0_rgba(255,255,255,0.4)] hover:border-white hover:-translate-y-1">
            ...
            >
                <div className="bg-blue-600 p-2.5 rounded-lg group-hover:scale-110 transition-transform shadow-md">
            ...
            >
                <div className="bg-emerald-600 p-2.5 rounded-lg group-hover:scale-110 transition-transform shadow-md">
