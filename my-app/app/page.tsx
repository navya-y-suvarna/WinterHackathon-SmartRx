...
export default function Home() {
  ...
  return (
    <div style={pageBg} className="min-h-screen w-full flex items-center justify-center font-sans">
      <main className="smart-rx-container flex w-full max-w-3xl flex-col items-center justify-between py-32 px-16 sm:items-start">
        <img
